...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    background:
      "要解决的问题是：让用户在不同端获得一致的 AI 对话与付费体验。使用场景包括移动端快速提问、H5 投放页转化、PC 长会话与 Electron 桌面使用。",
    challenge: [
  ...
  },
  {
    ...
    background:
      "要解决的问题是：授权码在代理渠道中的发放、库存与激活闭环，并按角色控制可见数据。使用场景是运营与渠道查看库存、审批发货、管理激活码与客户。",
    challenge: [
  ...
  },
  {
    ...
    background:
      "要解决的问题是：终端设备的在线状态、分组策略与镜像分发需要统一运维入口。使用场景是运维查看终端、按 IP/机器码检索，并配置激活与权限策略。",
    challenge: [
  ...
  },
  {
    ...
    background:
      "要解决的问题是：给终端侧分发应用与运营内容（推荐、轮播、活动），并管理设备与反馈。使用场景是运营配置应用元数据、上架状态，以及活动入口。",
    challenge: [

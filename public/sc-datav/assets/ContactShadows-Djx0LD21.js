import{l as e,o as t}from"./styled-components.browser.esm-BJd1O9xx.js";import{A as n,Dt as r,En as i,Ht as a,Tt as o,c as s,rn as c,t as l,u}from"./extends-l6GSDB8O.js";var d={uniforms:{tDiffuse:{value:null},h:{value:1/512}},vertexShader:`
      varying vec2 vUv;
  ...
  `},p=e(t()),m=p.forwardRef(({scale:e=10,frames:t=1/0,opacity:m=1,width:h=1,height:g=1,blur:_=1,near:v=0,far:y=10,resolution:b=512,smooth:x=!0,color:S=`#000000`,depthWrite:C=!1,renderOrder:w,...T},E)=>{let D=p.useRef(null),O=u(e=>e.scene),k=u(e=>e.gl),A=p.useRef(null);h*=Array.isArray(e)?e[0]:e||1,g*=Array.isArray(e)?e[1]:e||1;let[j,M,N,P,F,I,L]=p.useMemo(()=>{let e=new i(b,b),t=new i(b,b);t.texture.generateMipmaps=e.texture.generateMipmaps=!1;let s=new a(h,g).rotateX(Math.PI/2),l=new o(s),u=new r;u.depthTest=u.depthWrite=!1,u.onBeforeCompile=e=>{e.uniforms={...e.uniforms,ucolor:{value:new n(S)}},e.fragmentShader=e.fragmentShader.replace(`void main() {`,`uniform vec3 ucolor;
           void main() {
